...
select userType from users where emailId="rishabhsaggar30@gmail.com";
...
create table providers(emailid varchar(100), pname varchar(50), cnumber varchar(15),gender varchar(20), faddress varchar(100), haddress varchar(100),city varchar(40),state varchar(20),category varchar(100),firm varchar(100), website varchar(100), since int , ppic varchar(100), otherinfo varchar(1000)); 
